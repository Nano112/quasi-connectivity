...
<nav x-data="{ open: false }" class="text-white bg-gray-800 border-b border-gray-800">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    @foreach ($routes as $route)
                        <x-jet-nav-link href="{{ route($route['routeName']) }}"
                            :active="request()->routeIs($route['routeName'])">
                            {{ __($route['name']) }}
                        </x-jet-nav-link>
                    @endforeach
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @foreach ($routes as $route)
                <x-jet-responsive-nav-link href="{{ route($route['routeName']) }}"
                    :active="request()->routeIs($route['routeName'])">
                    {{ __($route['name']) }}
        ...
        @auth
            ...
            <div class="pt-4 pb-1 border-t border-gray-200">
                <div class="flex items-center px-4">
                    ...
                    <div>
                        <div class="text-base text-base font-medium">{{ Auth::user()->name }}</div>
